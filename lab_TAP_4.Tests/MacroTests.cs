...
namespace lab_TAP_4.Tests {
    ...
    public class MacroTests {
        ...
        public void NullParameters_ThrowsException(IEnumerable<int> sequence, int value, IEnumerable<int> newValues) {
            Assert.That(() => MacroClass.MacroExpansion(sequence, value, newValues), Throws.TypeOf<ArgumentNullException>());
        }
